...
const updateCheckRun_1 = require("./updateCheckRun");
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, core_1.info)(`Check run conclusion: ${SKIPPED}`);
        yield Promise.all(jobIds.map((jobId) => (() => __awaiter(this, void 0, void 0, function* () {
            (0, core_1.info)(`  Check id: ${jobId}`);
            return (0, updateCheckRun_1.updateCheckRun)(owner, repo, jobId, SKIPPED, octokit);
        }))()));
    });
}
run();
